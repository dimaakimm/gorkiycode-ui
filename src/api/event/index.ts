...
export const putCall = (id:number, time:Date, maxPeople: number): AxiosPromise =>
    axiosInstance.post(EventsEndpoints.COME_TO_EVENT, {playgroundId: id, startTime: time, isGeneralCollection: true, userMaxCount:maxPeople});
