...
const YandexMap = () => {
    ...
    const [requestsIsActive, setRequestsIsActive] = useState<boolean>(false)
    ...
    return (
        ...
        <div  className={styles.map}>
            ...
            <div className={styles.modals__button}>
                <div onClick={() => setFiltersIsActive(true)} className={styles.modal__button}>
                ...
                <div onClick={() => setRequestsIsActive(true)} className={styles.modal__button}>
